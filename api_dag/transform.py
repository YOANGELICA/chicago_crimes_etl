...
def split_datetime(df):
    ...
    logging.info(f"date column type: {type(df['date'].iloc[0])}")
...
def drop_columns(df):
    columns_to_drop = ['case_number', 'domestic', 'beat', 'ward', 'community_area', 'updated_on', 'fbi_code', 'x_coord', 'y_coord', 'primary_type', 'description', 'location']
